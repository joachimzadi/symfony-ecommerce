 ...
 */
final class Version20200813142937 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD categorie_id INT NOT NULL, ADD sous_categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP categorie_id, DROP sous_categorie_id');
    }
}
